...
<aside id="sidebar"
    class="hide-scrollbar fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-[96px] font-normal duration-75 lg:flex transition-width"
    aria-label="Sidebar">
    <div
            ...
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    @foreach ($sideLinks as $link)
                        <x-sidebar.link :type="$link['type']" :icon="$link['icon']" :text="$link['text']" :href="$link['href']"
                            :buttonTriggerIdentifier="$link['buttonTriggerIdentifier'] ?? ''" :collapseIdentifier="$link['collapseIdentifier'] ?? ''" :collapseItems="$link['collapseItems'] ?? []" :valueIndicator="$link['valueIndicator'] ?? null" />
                    @endforeach
                    <li>
        ...
        <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700"
                id="language-dropdown" data-popper-reference-hidden="" data-popper-escaped=""
                data-popper-placement="bottom"
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(0px, 9.77778px, 0px);">
                            ...
                            <div class="inline-flex items-center">
                                <svg class="h-3.5 w-3.5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <use width="30" height="20"
                                        transform="rotate(-121 142.6 -47) scale(25.5827)" xlink:href="#a"></use>
                                    <use width="30" height="20" transform="rotate(-98.1 198 -82) scale(25.6)"
                                        xlink:href="#a"></use>
                                    <use width="30" height="20"
                                        transform="rotate(-74 272.4 -114) scale(25.6137)" xlink:href="#a"></use>
                                    <use width="30" height="20"
                                        transform="matrix(16 -19.968 19.968 16 256 230.4)" xlink:href="#a"></use>
                                </svg>
                                中文 (繁體)
                            </div>
                        </a>
