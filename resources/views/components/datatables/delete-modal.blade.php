<div x-data="{ showDeleteModal: false, deletedId: null }" {{ $attributes }}>
    <div class="fixed top-0 left-0 right-0 z-[9999999] bg-gray-900/50 dark:bg-gray-900/90 items-center justify-center hidden overflow-x-hidden overflow-y-auto md:inset-0 h-modal sm:h-full"
        x-cloak x-show="showDeleteModal" x-bind:class="{ 'hidden': !showDeleteModal, 'flex': showDeleteModal }"
