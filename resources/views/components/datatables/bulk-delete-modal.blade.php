<div
    ...
    x-cloak
    x-data="{ showDeleteModal: false, queryParams: '' }" x-show="showDeleteModal"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex justify-end p-2">
                <button type="button"
                    ...
                    x-on:click="showDeleteModal = false; selectedIds = []">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <x-button.light type="button" x-on:click="showDeleteModal = false; selectedIds = []">
                    No, cancel
                </x-button.light>
            </div>
        </div>
