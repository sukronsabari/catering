        ...
        <div class="col-span-full xl:col-auto">
            ...
            >
                <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                    <img id="profile-image-preview" class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0 object-cover"
                    ...
                    <div>
                        ...
                        <form id="profile-image-form" action="{{ route('admin.profile.image.update') }}" method="POST" enctype="multipart/form-data" class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <input id="profile-image-input" name="image" type="file" class="hidden" @change="previewImage" />
                            </div>
